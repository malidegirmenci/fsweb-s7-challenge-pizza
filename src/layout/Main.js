...
import img7 from '../Assets/adv-aseets/food-1.png'
import img8 from '../Assets/adv-aseets/food-2.png'
import img9 from '../Assets/adv-aseets/food-3.png'
                    ...
                    <div className='foods'>
                        <div className='food'>
                            ...
                            <div className='food-footer'>
                                <p className='opacity'>4.9</p>
                                <p className='opacity'>(200)</p>
                                <p>60₺</p>
                            </div>
                        </div>
                        <div className='food'>
                            <img src={img8} alt='Position Absolute Pizza' />
                            <h4>Position Absolute Pizza</h4>
                            <div className='food-footer'>
                                <p className='opacity'>4.9</p>
                                <p className='opacity'>(928)</p>
                                <p>85₺</p>
                            </div>
                        </div>
                        <div className='food'>
